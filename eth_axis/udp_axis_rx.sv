...
// Accumulate the complete IPv4 header, including options.  A packet is not
// offered to the user side unless the one's-complement sum is 16'hffff.
always @ ( posedge sys_clk or negedge sys_rst_n ) begin
	if ( !sys_rst_n ) begin
